...
export class IfcSectionedSpine extends IfcGeometricRepresentationItem {
    public SpineCurve: IfcCompositeCurveSegment[];
    public CrossSections: IfcProfileDef[];
    public CrossSectionPositions: IfcAxis2Placement3D[];
    ...
    public constructor(props?: IfcSectionedSpine) {
        ...
        if (props) {
        	...
        	this.SpineCurve = props.SpineCurve?.map(o => new IfcCompositeCurveSegment(o));
        	this.CrossSections = props.CrossSections?.map(o => o);
        	this.CrossSectionPositions = props.CrossSectionPositions?.map(o => new IfcAxis2Placement3D(o));
        }
    }
}
